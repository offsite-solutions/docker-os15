...
docker rm -f offsite_base_dev7 & docker run -d -p 10080:80 -p 9010:9010 -p 10443:443 --name offsite_base_dev7 --entrypoint /usr/local/bin/start.sh os15-php74-dev:$VER
